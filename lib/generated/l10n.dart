...
class S {
  ...
  /// `프로젝트가 정상적으로 등록되었습니다.`
  String get project_form_created {
    return Intl.message(
      '프로젝트가 정상적으로 등록되었습니다.',
      name: 'project_form_created',
      desc: '',
      args: [],
    );
  }
  ...
  String get project_form_updated {
    return Intl.message(
      '프로젝트 정보가 정상적으로 변경되었습니다.',
      name: 'project_form_updated',
      desc: '',
      args: [],
    );
  }
  ...
  /// `프로젝트가 삭제되었습니다.`
  String get project_form_deleted {
    return Intl.message(
      '프로젝트가 삭제되었습니다.',
      name: 'project_form_deleted',
      desc: '',
      args: [],
    );
  }
  ...
  /// `업무가 정상적으로 등록되었습니다.`
  String get issue_form_created {
    return Intl.message(
      '업무가 정상적으로 등록되었습니다.',
      name: 'issue_form_created',
      desc: '',
      args: [],
    );
  }
  ...
  /// `업무가 삭제되었습니다.`
  String get issue_form_deleted {
    return Intl.message(
      '업무가 삭제되었습니다.',
      name: 'issue_form_deleted',
      desc: '',
      args: [],
    );
  }

  /// `발주 요청이 정상적으로 등록되었습니다.`
  String get issue_form_procurement_requested_created {
    return Intl.message(
      '발주 요청이 정상적으로 등록되었습니다.',
      name: 'issue_form_procurement_requested_created',
      desc: '',
      args: [],
    );
  }
  ...
  /// `일정이 정상적으로 등록되었습니다.`
  String get schedule_form_created {
    return Intl.message(
      '일정이 정상적으로 등록되었습니다.',
      name: 'schedule_form_created',
      desc: '',
      args: [],
    );
  }
  ...
  /// `일정이 삭제되었습니다.`
  String get schedule_form_deleted {
    return Intl.message(
      '일정이 삭제되었습니다.',
      name: 'schedule_form_deleted',
      desc: '',
      args: [],
    );
  }
  ...
  /// `임원은 국내 출장 일비가 지급되지 않습니다.`
  String get report_form_domestic_executive_no_daily_allowance {
    return Intl.message(
      '임원은 국내 출장 일비가 지급되지 않습니다.',
      name: 'report_form_domestic_executive_no_daily_allowance',
      desc: '',
      args: [],
    );
  }
  ...
  /// `내 정보`
  String get account_segment_1 {
    return Intl.message(
      '내 정보',
      name: 'account_segment_1',
      desc: '',
      args: [],
    );
  }
