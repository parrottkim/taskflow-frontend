...
@ProviderFor(addressConfmKey)
final addressConfmKeyProvider = AddressConfmKeyProvider._();

final class AddressConfmKeyProvider
    extends $FunctionalProvider<String, String, String>
    with $Provider<String> {
  AddressConfmKeyProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'addressConfmKeyProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$addressConfmKeyHash();
...
String _$addressConfmKeyHash() => r'06ac8cf284cd0d31cb1b7ed492b0f0177f2ef998';

@ProviderFor(addressHttp)
final addressHttpProvider = AddressHttpProvider._();

final class AddressHttpProvider extends $FunctionalProvider<Dio, Dio, Dio>
    with $Provider<Dio> {
  AddressHttpProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'addressHttpProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$addressHttpHash();
...
String _$addressHttpHash() => r'4349d64e47acf3d5450f6ac07d2364497f130548';
