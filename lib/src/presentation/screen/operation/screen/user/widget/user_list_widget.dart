          ...
          child: DataTable(
            ...
            columns: [
              DataColumn(
                ...
                label: Text(
                  Intl.message('operation_user_column_1'),
              ...
              DataColumn(
                columnWidth: FlexColumnWidth(),
                label: Text(
                  Intl.message('operation_user_column_2'),
                  style: textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: colorScheme.onSurface.withValues(alpha: 0.7),
                  ),
              ...
              DataColumn(
                columnWidth: FlexColumnWidth(),
                label: Text(
                  Intl.message('operation_user_column_3'),
                  style: textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: colorScheme.onSurface.withValues(alpha: 0.7),
                  ),
              ...
              DataColumn(
                columnWidth: FlexColumnWidth(),
                label: Text(
                  Intl.message('operation_user_column_4'),
                  style: textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: colorScheme.onSurface.withValues(alpha: 0.7),
                  ),
              ...
              DataColumn(
                ...
                label: Text(
                  Intl.message('operation_user_column_5'),
                  style: textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: colorScheme.onSurface.withValues(alpha: 0.7),
                  ),
              ...
              DataColumn(
                columnWidth: FixedColumnWidth(100.0),
                label: Text(
                  Intl.message('operation_user_column_6'),
                  style: textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: colorScheme.onSurface.withValues(alpha: 0.7),
                  ),
              ...
              DataColumn(
                ...
                label: Text(
                  Intl.message('operation_user_column_7'),
                  style: textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: colorScheme.onSurface.withValues(alpha: 0.7),
                  ),
              ...
              child: SingleChildScrollView(
                child: DataTable(
                  ...
                  columns: [
                    DataColumn(
                      columnWidth: FlexColumnWidth(),
                      label: Text(Intl.message('operation_user_column_1')),
                    ),
                    DataColumn(
                      columnWidth: FlexColumnWidth(),
                      label: Text(Intl.message('operation_user_column_2')),
                    ),
                    DataColumn(
                      columnWidth: FlexColumnWidth(),
                      label: Text(Intl.message('operation_user_column_3')),
                    ),
                    DataColumn(
                      columnWidth: FlexColumnWidth(),
                      label: Text(Intl.message('operation_user_column_4')),
                    ),
                    DataColumn(
                      columnWidth: FixedColumnWidth(100.0),
                      label: Text(Intl.message('operation_user_column_5')),
                    ),
                    DataColumn(
                      columnWidth: FixedColumnWidth(100.0),
                      label: Text(Intl.message('operation_user_column_6')),
                    ),
                    DataColumn(
                      columnWidth: FixedColumnWidth(80.0),
                      label: Text(Intl.message('operation_user_column_7')),
                    ),
                  ],
                  rows: List.generate(
                    items.length,
