...
import 'package:taskflow/src/presentation/screen/work/screen/project_list/widget/mobile_category_filter_widget.dart';
import 'package:taskflow/src/presentation/screen/work/screen/project_list/widget/mobile_client_filter_widget.dart';
import 'package:taskflow/src/presentation/screen/work/screen/project_list/widget/mobile_sort_filter_widget.dart';
import 'package:taskflow/src/presentation/widget/widget.dart';

typedef WorkProjectFilterApplyCallback =
    void Function(
...
class MobileFilterDialog extends HookWidget {
  final WorkProjectSortOption? sort;
  ...
  final WorkProjectFilterApplyCallback onApply;
  ...
  Widget build(BuildContext context) {
    ...
    final selectedSort = useState<WorkProjectSortOption?>(sort);
