...
import 'package:taskflow/src/presentation/screen/work/screen/project_list/widget/mobile_filter_dialog.dart';
      ...
      onPressed: () => showDialog<void>(
        ...
        builder: (_) => MobileFilterDialog(
          ...
          onApply: (sort, order, clients, categories) {
            ref.read(workProjectFilterControllerProvider.notifier)
              ..setSort(sort: sort)
