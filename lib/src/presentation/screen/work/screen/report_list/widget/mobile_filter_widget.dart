...
import 'package:taskflow/src/presentation/screen/work/screen/report_list/widget/mobile_filter_dialog.dart';
...
class MobileFilterWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final options = ref.watch(workReportOptionsControllerProvider);
    ...
    return ElevatedButton.icon(
      onPressed: () => showDialog<void>(
        ...
        builder: (_) => MobileFilterDialog(
          ...
          onApply: (sort, order, clients, categories, start, end) {
