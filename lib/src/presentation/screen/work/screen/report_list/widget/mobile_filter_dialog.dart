...
import 'package:taskflow/src/presentation/screen/work/screen/report_list/widget/mobile_category_filter_widget.dart';
import 'package:taskflow/src/presentation/screen/work/screen/report_list/widget/mobile_client_filter_widget.dart';
import 'package:taskflow/src/presentation/screen/work/screen/report_list/widget/mobile_date_range_filter_widget.dart';
import 'package:taskflow/src/presentation/screen/work/screen/report_list/widget/mobile_sort_filter_widget.dart';
...
class MobileFilterDialog extends HookWidget {
  ...
  final List<ScheduleCategory> categoryItems;
  final int maxClientDepth;
  final WorkReportFilterApplyCallback onApply;
  ...
  Widget build(BuildContext context) {
    ...
    final selectedEndDate = useState<DateTime?>(end);
