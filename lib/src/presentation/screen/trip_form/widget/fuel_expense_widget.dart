  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            Intl.message('trip_form_column_6'),
                ...
                label: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 4.0),
                      Text(
                        Intl.message('trip_form_column_7'),
                        style: textTheme.bodyMedium?.copyWith(
                          fontWeight: FontWeight.w600,
                          color: colorScheme.onSurface.withValues(alpha: 0.7),
                        ),
                ...
                label: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 4.0),
                      Text(
                        Intl.message('trip_form_column_8'),
                        style: textTheme.bodyMedium?.copyWith(
                          fontWeight: FontWeight.w600,
                          color: colorScheme.onSurface.withValues(alpha: 0.7),
                        ),
                ...
                label: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 4.0),
                      Text(
                        Intl.message('trip_form_column_9'),
                        style: textTheme.bodyMedium?.copyWith(
                          fontWeight: FontWeight.w600,
                          color: colorScheme.onSurface.withValues(alpha: 0.7),
                        ),
          ...
          InvalidWidget(
            visible: isFuelInvalid.value,
            text: Intl.message('trip_form_invalid_4'),
          ),
        ],
      ),
    );
