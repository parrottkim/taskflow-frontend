...
import 'package:taskflow/src/presentation/screen/project/screen/report_category/widget/schedule_select_dialog.dart';
import 'package:taskflow/src/presentation/widget/widget.dart';
import 'package:taskflow/src/shared/tool/functions.dart';

class ScheduleSelectWidget extends HookConsumerWidget {
  final int projectId;
  final int? reportId;
        ...
        Skeleton.unite(
          child: ElevatedButton.icon(
            onPressed: () {
              ...
              showDialog(
                context: context,
                builder: (_) => ScheduleSelectDialog(
                  projectId: projectId,
