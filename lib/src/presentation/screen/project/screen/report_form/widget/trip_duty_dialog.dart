      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildAllowanceCard('주중', '당일 출장', meal: '실비'),
            _buildAllowanceCard(
              '주말',
              '회사 정상근무',
              meal: '실비',
            ...
            _buildAllowanceCard('주중', '근무 없이 단순 이동일', meal: '실비'),
            _buildAllowanceCard('주중', '회사/공장 근무 포함 이동', allowance: '35,000'),
            _buildAllowanceCard(
              '주말',
              '근무 없이 단순 이동 (토요일 등)',
              allowance: '35,000',
            ...
            children: [
              SizedBox(
                ...
                child: Text(
                  dayType,
                  style: TextStyle(
                    color: isWeekend ? Colors.redAccent : Colors.blueAccent,
