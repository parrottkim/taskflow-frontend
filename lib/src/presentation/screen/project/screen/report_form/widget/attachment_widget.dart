...
import 'package:taskflow/src/presentation/screen/project/screen/report_form/widget/file_item_widget.dart';
import 'package:taskflow/src/presentation/screen/project/screen/report_form/widget/attachment_item_widget.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            Intl.message('report_form_description_2'),
