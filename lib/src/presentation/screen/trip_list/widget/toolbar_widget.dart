                  ...
                  onPressed: () async {
                    final result = await showDialog(
                      ...
                      builder: (_) => DeleteDialog(
                        title: Intl.message('trip_form_delete_dialog_1'),
                        content: Intl.message('trip_form_delete_dialog_2'),
                      ),
                    );
                    ...
                    if (result) {
                      await ref
                          ...
                          .deleteTrip(projectId: projectId, tripId: item.id);

                      ref.read(toastProvider).showToast(
                            child: Toast(
                              type: ToastType.standard,
                              message: Intl.message('trip_form_delete'),
                            ),
                          );
                    }
                  },
