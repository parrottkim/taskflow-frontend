...
import 'package:taskflow/src/presentation/screen/issue_form/widget/supplier_search_dialog.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final purchaseUrlControllers = useMemoized(
      () =>
          items
              ?.map(
                (element) => TextEditingController(text: element.purchaseUrl),
              )
              .toList() ??
          [],
      [items?.length],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          InvalidWidget(
            visible: hasProcurementItems.value,
            text: Intl.message('issue_form_procurement_item_invalid_1'),
          ),
          InvalidWidget(
            visible: isProcurementItemEmpty.value,
