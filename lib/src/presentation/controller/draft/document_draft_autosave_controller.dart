...
@riverpod
class DocumentDraftAutosaveController
    extends _$DocumentDraftAutosaveController {
  ...
  Future<void> _save(DocumentDraftPayload payload, List<XFile> files) async {
    try {
      ...
      await ref
          ...
          .save(payload: payload, files: files, documentId: documentId);
