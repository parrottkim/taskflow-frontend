...
@riverpod
class ReportDraftController extends _$ReportDraftController {
  @override
  ...
  Future<DraftState> _init() async {
    ...
    final filteredDrafts = drafts
        .where(
          (draft) =>
              draft.type == DraftFormType.report &&
  ...
  Future<void> save({
    ...
    final draftContext = {'projectId': projectId, 'scheduleId': scheduleId};
    ...
    final draft = switch (currentDraft) {
      ...
      null => Draft(
        ...
        mode: reportId == null ? DraftMode.create : DraftMode.edit,
